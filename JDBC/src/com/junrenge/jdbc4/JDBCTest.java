...
public class JDBCTest {
	...
	public void testDBCP() throws SQLException{
		...
		dataSource.setUrl("jdbc:mysql:///testjdbc");
	...
	public void testBatch(){
		...
		try {
			connection = JDBCTools.getConnection1();
			...
			System.out.println("Time: " + (end - begin)); //12229
	...
	public void testBatchWithPreparedStatement(){
		...
		try {
			...
			System.out.println("Time: " + (end - begin)); //16482
	...
	/**
	 * 向  Mysql 的 student 数据表中插入 10 万条记录
	 * 测试如何插入, 用时最短. 
	 * 1. 使用 Statement.
	 */
	@Test
	public void testBatchWithStatement(){
		...
		try {
			...
			long begin = System.currentTimeMillis();
			for(int i = 0; i < 100000; i++){
				sql = "INSERT INTO student VALUES("+ (i+1) +",'name"+ (i+1) +"', "+ i +")";
				statement.executeUpdate(sql);
			}
			long end = System.currentTimeMillis();
			
			System.out.println("Time: " + (end - begin)); //21041
