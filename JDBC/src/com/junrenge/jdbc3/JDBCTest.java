...
public class JDBCTest {
	...
	public void testInsertBlob(){
		...
		try {
			connection = JDBCTools.getConnection();
			String sql = "INSERT INTO student(sname, sage, snumber, picture)" 
					+ "VALUES(?,?,?,?)";
			preparedStatement = connection.prepareStatement(sql);
			
			preparedStatement.setString(1, "ABCDE");
			preparedStatement.setInt(2,12);
			preparedStatement.setString(3,"005");
			InputStream inputStream = new FileInputStream("ponyu.jpg");
	...
	public void testGetKeyValue() {
		...
		try {
			connection = JDBCTools.getConnection();
			String sql = "INSERT INTO student(sname, sage, snumber)" +
					"VALUES(?,?,?)";
//			preparedStatement = connection.prepareStatement(sql);
			...
			preparedStatement.setString(1, "ACDE");
			preparedStatement.setInt(2, 12);
			preparedStatement.setString(3,"004");
