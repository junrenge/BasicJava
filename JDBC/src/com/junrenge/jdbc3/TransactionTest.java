...
public class TransactionTest {
	...
	public void testTransactionIsolationUpdate() {
		...
		try {
			...
			String sql = "UPDATE student SET balance = "
					+ "balance - 50 WHERE id = 4";
	...
	public void testTransactionIsolationRead() {
		String sql = "SELECT balance FROM student WHERE id = 4";
...
//			connection.setTransactionIsolation(Connection.TRANSACTION_READ_UNCOMMITTED);
	...
	public void testTransaction() {
		...
		try {
			...
			connection.setAutoCommit(false);
			System.out.println(connection.getAutoCommit());
			String sql = "UPDATE student SET balance = balance - 50 WHERE id = 4";
			update(connection, sql);

			int i = 10 / 0;
			System.out.println(i);

			sql = "UPDATE student SET balance = balance + 50 WHERE id = 5";
			update(connection, sql);
