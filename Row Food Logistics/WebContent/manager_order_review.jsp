...
<br><br>
<form action="/Row_Food_Logistics/actionjsp/order.jsp?method=mrshow" method="post">
			...
			%>
				<tr>
					...
					<%
						...
						if(!c.getReview().equals("1")){
						%>
						<td><a href="/Row_Food_Logistics/actionjsp/order.jsp?method=review&id=<%=c.getId() %>">审核</a></td>
						<%
						}
						%>
				</tr>
