...
<h1><a href=/Row_Food_Logistics/manager_home.jsp target="_blank">管理员登录</a>>><a href=/Row_Food_Logistics/manager_order.jsp target="blank">订单管理</a>>>创建物流规划</h1>
<br><br>
<form action="/Row_Food_Logistics/actionjsp/order.jsp?method=mcshow" method="post">
				...
				<tr>
					...
					<%
						if(c.getPlan().equals("1")){
							...
							%>
							<td>---</td>
							<td><a href="/Row_Food_Logistics/actionjsp/order.jsp?method=plan&id=<%=c.getId() %>">创建</a></td>
							<%
						}
					%>
				</tr>
